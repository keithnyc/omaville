...
Generation source: `/home/keith/.codex/generated_images/01a06da5-f528-7f60-9899-17d3d2253752/exec-16fe319f-381f-4455-bb7c-b6d3f7ef682c.png`.

Export command (from omaville directory):

```bash
magick /home/keith/.codex/generated_images/01a06da5-f528-7f60-9899-17d3d2253752/exec-16fe319f-381f-4455-bb7c-b6d3f7ef682c.png -channel A -threshold 5% +channel -trim +repage -filter Lanczos -resize 240x240 -gravity south -background none -extent 256x248 -gravity north -extent 256x256 -strip -define png:color-type=6 assets/industrial/i3e.png
```
...
Generation source: `/home/keith/.codex/generated_images/01a06da5-f528-7f60-9899-17d3d2253752/exec-f9f48c3c-2f8a-4766-b534-c739806b5ffd.png`.

Export command (from omaville directory):

```bash
magick /home/keith/.codex/generated_images/01a06da5-f528-7f60-9899-17d3d2253752/exec-f9f48c3c-2f8a-4766-b534-c739806b5ffd.png -channel A -threshold 5% +channel -trim +repage -filter Lanczos -resize 240x240 -gravity south -background none -extent 256x248 -gravity north -extent 256x256 -strip -define png:color-type=6 assets/industrial/i3f.png
```
...
Generation source: `/home/keith/.codex/generated_images/01a06da5-f528-7f60-9899-17d3d2253752/exec-c5a98df3-c032-4015-aee5-32c453b3adbd.png`.

Export command (from omaville directory):

```bash
magick /home/keith/.codex/generated_images/01a06da5-f528-7f60-9899-17d3d2253752/exec-c5a98df3-c032-4015-aee5-32c453b3adbd.png -channel A -threshold 5% +channel -trim +repage -filter Lanczos -resize 240x240 -gravity south -background none -extent 256x248 -gravity north -extent 256x256 -strip -define png:color-type=6 assets/industrial/i3g.png
```
...
Generation source: `/home/keith/.codex/generated_images/01a06da5-f528-7f60-9899-17d3d2253752/exec-3b015438-50d9-4586-9533-95ddd49db127.png`.
...
Transparent source: `/home/keith/.codex/generated_images/01a06da5-f528-7f60-9899-17d3d2253752/exec-21f807f0-5f9e-4993-8239-56463567b182.png`.

Export command (from omaville directory):

```bash
magick /home/keith/.codex/generated_images/01a06da5-f528-7f60-9899-17d3d2253752/exec-21f807f0-5f9e-4993-8239-56463567b182.png -channel A -threshold 5% +channel -trim +repage -filter Lanczos -resize 240x240 -gravity south -background none -extent 256x248 -gravity north -extent 256x256 -strip -define png:color-type=6 assets/industrial/i3h.png
```
